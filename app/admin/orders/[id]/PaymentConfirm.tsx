...
export default function PaymentConfirm({
  ...
  function buildWhatsAppLink() {
    ...
    message +=
      ...
      " এর জন্য ৳" +
      paymentAmountPaid +
      " টাকা পেমেন্ট আমরা পেয়েছি। ধন্যবাদ আমাদের সাথে থাকার জন্য!\n";
    if (dueAmount > 0) {
      message +=
  ...
  return (
    <div className="bg-pink-50 border border-pink-200 rounded-xl p-4 mt-4">
      ...
      <p className="text-gray-600 text-sm">
        <span className="font-medium">মাধ্যম:</span> {gatewayName}
      </p>
      <p className="text-gray-600 text-sm mt-1">
        <span className="font-medium">Transaction ID:</span> {gatewayTxnId}
      </p>

      {paymentAmountPaid > 0 && (
        <p className="text-blue-700 text-sm font-bold mt-2">
          ✅ এখন পর্যন্ত পরিশোধ হয়েছে: ৳ {paymentAmountPaid}{" "}
      ...
      {isFullyPaid || isPartialPaid ? (
        <div className="mt-3">
          <p className="text-green-700 font-bold text-sm">
            {isFullyPaid
              ? "✅ সম্পূর্ণ পেমেন্ট কনফার্ম করা হয়েছে"
              : "🟡 আংশিক পেমেন্ট কনফার্ম করা হয়েছে"}
          </p>
          <a
