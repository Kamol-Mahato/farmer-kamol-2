...
const navItems = [
  { label: "ড্যাশবোর্ড", href: "/admin", agentVisible: false },
  {
    ...
    href: "/admin/orders",
    agentHref: "/agent/orders",
    agentVisible: true,
  },
  {
    label: "লাইভ চ্যাট",
    href: "/admin/chat",
    agentHref: "/agent/chat",
    agentVisible: true,
  },
  { label: "পণ্য ম্যানেজমেন্ট", href: "/admin/products", agentVisible: false },
  {
    label: "কাস্টমার ম্যানেজমেন্ট",
  ...
  {
    label: "বিনিয়োগ প্রজেক্ট",
    href: "/admin/projects",
    agentVisible: false,
  },
  {
    label: "বিনিয়োগ লেনদেন",
        ...
        {isOpen && roleReady && (
          <nav className="flex flex-col gap-1 mt-8">
            {visibleItems.map((item) => {
              const resolvedHref =
                isAgent && item.agentHref ? item.agentHref : item.href;
              const isActive =
