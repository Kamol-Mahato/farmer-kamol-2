...
export default function CreateOrderForm({ basePath, products }: Props) {
  ...
  function updateProduct(index: number, productId: number) {
    ...
    setItems((prev) =>
      prev.map((it, i) =>
        i === index
          ? { ...it, productId, price: (p?.pricePerUnit || 0) * it.quantity }
          : it,
      ),
    );
  }
  ...
  function addItem() {
    ...
    setItems((prev) => [
      ...prev,
      { productId: p?.id || 0, quantity: 1, price: p?.pricePerUnit || 0 },
    ]);
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
          ...
          <div>
            ...
            {foundCustomer && (
              <p className="text-xs font-bold text-green-700 mt-1">
                ✅ পুরনো কাস্টমার পাওয়া গেছে — তথ্য বসিয়ে দেওয়া হয়েছে
              </p>
            )}
          </div>
          <input
        ...
        <div className="space-y-6">
          <div className="bg-white border border-black rounded-xl p-6 space-y-3">
              ...
              <div key={i} className="flex flex-wrap gap-2 items-center">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    value={item.price}
                    onChange={(e) =>
                      updatePrice(i, parseFloat(e.target.value) || 0)
                    }
            ...
            <p className="text-xs text-gray-400">
              দামের ঘরে শপ-প্রাইস ডিফল্ট বসবে, চাইলে বদলে নিতে পারবেন
            </p>
          </div>
          ...
          <div className="bg-white border border-black rounded-xl p-6 space-y-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-600 w-32 shrink-0 text-sm">
                শিপিং চার্জ
              </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-32 border border-green-500 rounded-lg px-3 py-2 text-sm font-bold"
              />
            </div>
            <p className="text-xs text-gray-400">
              বিকাশ/নগদে আগেই টাকা পেয়ে থাকলে এখানে বসান — বাকি (Due) নিজে
              থেকেই হিসেব হয়ে যাবে
            </p>
            <div className="pt-2 border-t space-y-1 text-sm font-bold text-gray-700">
              ...
              <p className={due > 0 ? "text-red-600" : "text-green-700"}>
                বাকি (Due): ৳ {due}
              </p>
            </div>
          </div>
      ...
      <div className="flex gap-3">
        ...
        <a
          href={basePath}
          className="border border-gray-400 px-6 py-2.5 rounded-lg font-bold text-sm"
        >
          বাতিল
        </a>
      </div>
