...
export default function MobileBottomNav() {
  ...
  return (
    <>
     <nav className="md:hidden fixed bottom-0 left-0 w-full bg-green-800 border-t border-green-700 z-[60] flex items-center justify-around py-2 shadow-lg">
        <Link href={href("/")} className={`flex flex-col items-center text-xs gap-1 px-3 py-1 ${isActive(href("/")) ? "text-yellow-400" : "text-white"}`}>
