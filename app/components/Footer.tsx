        ...
        <div className="grid grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="col-span-4 md:col-span-1">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {/* ১. নতুন ইমেইল বাটন (লাল চিহ্ন ১) */}
              <a href={`mailto:${siteConfig.contact.email}`} aria-label="Email Us"
                className="w-8 h-8 rounded-full bg-emerald-600 hover:bg-emerald-500 flex items-center justify-center transition">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex flex-col gap-1.5 text-sm text-black">
              ...
              {/* ২. নতুন ইমেইল টেক্সট লিঙ্ক (লাল চিহ্ন ২) */}
