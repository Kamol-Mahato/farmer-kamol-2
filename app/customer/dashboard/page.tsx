...
export default function CustomerDashboard() {
  ...
  const [customer, setCustomer] = useState<{ name: string; id: number } | null>(
    null,
  );
      ...
      <div className="bg-green-50 rounded-2xl p-6 mb-8 border border-green-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            আপনার অ্যাকাউন্টে স্বাগতম। এখান থেকে আপনার অর্ডারের লাইভ ট্র্যাকিং
            দেখতে পারবেন।
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Link
            href="/shop"
            className="bg-green-700 text-white px-5 py-2.5 rounded-xl font-bold text-sm text-center hover:bg-green-600 transition"
          >
