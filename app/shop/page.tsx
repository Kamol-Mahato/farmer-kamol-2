...
export const metadata: Metadata = {
  ...
  description: `${siteConfig.brand.name}-এর সব পণ্য একসাথে দেখুন — খাঁটি মধু, দেশি ঘি, সরিষার তেল ও চীন হাঁসের বাচ্চা, সরাসরি ${siteConfig.address.region}ের খামার থেকে।`,
  alternates: {
    canonical: "/shop",
  },
};
