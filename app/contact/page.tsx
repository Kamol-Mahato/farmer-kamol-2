...
export const metadata: Metadata = {
  ...
  description: `${siteConfig.brand.name}-এর সাথে ফোন, হোয়াটসঅ্যাপ, ফেসবুক বা ইউটিউবে যোগাযোগ করুন। আমাদের খামার: ${siteConfig.address.locality}, ${siteConfig.address.region}।`,
  alternates: {
    canonical: "/contact",
    languages: {
      bn: "/contact",
  ...
  return (
    <main className="pt-6 sm:pt-10 pb-6 bg-white">
      <div className="max-w-2xl mx-auto px-2 flex flex-col items-center text-center">
        ...
        {/* Social & Contact Icons Circle Row */}
        <div className="flex gap-2 sm:gap-4 mt-4 sm:mt-12 flex-wrap justify-center items-center">
          {/* Facebook */}
          <div className="relative group">
            <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 bg-gray-900 text-white text-xs font-medium rounded opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 shadow-lg">
              Facebook
            </span>
            <a
          ...
          <div className="relative group">
            ...
            <a
              ...
              aria-label="ফোন করুন"
              className="w-9 h-9 sm:w-14 sm:h-14 rounded-full bg-gray-800 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="relative group">
            ...
            <a
              ...
              aria-label="Email Us"
              className="w-9 h-9 sm:w-14 sm:h-14 rounded-full bg-emerald-600 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <a
          href={`mailto:${siteConfig.contact.email}`}
          className="mt-3 flex items-center justify-center gap-2 text-gray-600 text-sm hover:text-yellow-600 transition"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
