  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a
          href="/agent/orders"
          className="block bg-white p-6 rounded-2xl border border-black hover:shadow-md transition-shadow"
        >
            ...
            <div className="p-3 bg-gray-100 rounded-xl text-black">
              ...
              >
                <path
                  ...
                  d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm11.25 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-14.63-13.5h16.5a1.5 1.5 0 0 1 1.5 1.5v.75A1.5 1.5 0 0 1 20.25 4.5h-16.5A1.5 1.5 0 0 1 2.25 3v-.75A1.5 1.5 0 0 1 3.75 2.25Z"
                />
              </svg>
            </div>
          </div>
          <p className="text-xs text-black mt-4 font-bold">
            → সব অর্ডার দেখুন ও স্ট্যাটাস আপডেট করুন
          </p>
        </a>
