...
const faqGroups = [
  {
    category: `${siteConfig.brand.name} সম্পর্কে`,
    items: [
      {
        q: `${siteConfig.brand.name} কী?`,
        a: `${siteConfig.brand.name} হলো ${siteConfig.address.region}ের ${siteConfig.address.locality}, ${siteConfig.address.village} ভিত্তিক একটি কৃষি-পণ্যের ব্র্যান্ড, যা সরাসরি খামার থেকে খাঁটি মধু, ঘি, সরিষার তেল ও চীন হাঁসের বাচ্চা গ্রাহকের কাছে পৌঁছে দেয়, কোনো মধ্যস্থতাকারী ছাড়া।`,
      },
      {
        q: `${siteConfig.brand.name}-এর পণ্য কি নিজস্ব খামার থেকে আসে?`,
        a: `হ্যাঁ। ${siteConfig.brand.name}-এর পণ্য নিজস্ব খামার ও বিশ্বস্ত উৎস থেকে সংগ্রহ করা হয়। উৎপাদন ও সংগ্রহ প্রক্রিয়ার ভিডিও আমাদের YouTube চ্যানেলে প্রকাশ করা হয়।`,
      },
      {
        q: `${siteConfig.brand.name}-এর ভিডিও কোথায় দেখতে পারি?`,
      ...
      {
        q: `${siteConfig.brand.name} কী কী পণ্য বিক্রি করে?`,
      ...
      {
        q: `কেন ${siteConfig.brand.name} থেকে পণ্য কিনবেন?`,
      ...
      {
        q: `${siteConfig.brand.name}-এর লক্ষ্য কী?`,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: `খাঁটি মধু চেনার সবচেয়ে ভালো উপায় হলো এর উৎস ও বিক্রেতার বিশ্বাসযোগ্যতা যাচাই করা। ${siteConfig.brand.name} মধু সংগ্রহ ও প্রক্রিয়াকরণের বাস্তব ভিডিও প্রকাশ করে, যাতে গ্রাহক উৎপাদন প্রক্রিয়া সম্পর্কে ধারণা পান।`,
      },
      {
...

      {
        ...
        a: `আমাদের সব পণ্য আসে ${siteConfig.address.region}ের ${siteConfig.address.locality}ের নিজস্ব খামার থেকে। উৎপাদন প্রক্রিয়ার ভিডিও আমাদের YouTube চ্যানেলে দেখতে পারবেন।`,
      },
      {
      ...
      {
        q: "চীনা হাঁসের বাচ্চা কীভাবে অর্ডার করব?",
        a: `চীনা হাঁসের বাচ্চার দাম বয়স ও সাইজ অনুযায়ী ভিন্ন হয়, তাই এর জন্য নির্দিষ্ট কোনো ফিক্সড দাম নেই। অর্ডার করতে চাইলে সরাসরি হোয়াটসঅ্যাপে ${siteConfig.contact.phoneDisplay} যোগাযোগ করুন, আলোচনার মাধ্যমে দাম ও পরিমাণ ঠিক হবে। আপনার লোকেশন অনুযায়ী ডেলিভারি সম্ভব কিনা যাচাই করা হবে, এবং ডেলিভারির আগে পেমেন্ট সম্পন্ন করতে হয়।`,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "ডেলিভারি পাওয়ার সময় যদি ড্যামেজ পণ্য পেয়ে থাকেন সাথে সাথে আমাদের হোয়াটসঅ্যাপে জানান, প্রয়োজনে ছবি/ভিডিও সহ। বিস্তারিত শর্তের জন্য আমাদের রিটার্ন পলিসি দেখুন।",
      },
      {
    ...
    items: [
      {
        ...
        a: `আমাদের খামার ${siteConfig.address.region} জেলার ${siteConfig.address.locality} উপজেলার ${siteConfig.address.village} গ্রামে অবস্থিত।`,
      },
      {
